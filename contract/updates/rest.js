	...
	*/
    ...
    if(req.method == "PUT"){
      //update document
        ...
        var fields = [ 'nume', 'contract', 'start_date', 'end_date', 'detalii', 'supplier_id'];
    ...
    if(req.method == "POST"){
        ...
        if(doc === null){
            ...
            newdoc = {};
            newdoc['_id'] = req['uuid'];
            newdoc['doctype'] = "CONTRACT";
            var fields = [ 'nume', 'contract', 'start_date', 'end_date', 'detalii', 'id', 'supplier_id'];
            fields.forEach(function(elm, idx){
